...
const UpdateJobs = () => {
    ...
    const { jobTitle, companyName, companyBanner, location, employmentType, experienceLevel, salaryRange, companyWebsite, industry } = job;
                ...
                <form onSubmit={handleSubmit} className="container flex flex-col mx-auto space-y-12">
                    <fieldset className=" gap-6 p-6 rounded-md shadow-sm bg-gray-50">
                        <div className="space-y-2 col-span-full text-center mb-4 lg:col-span-1">
                            <p className="font-medium text-5xl">Update Job Information</p>
                            <p className="text-xs">Update the job you are offering, please fill up all the fields!</p>
                        </div>
                        <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                            <div className="col-span-full sm:col-span-3">
                                <label className="text-sm">Job Title</label>
                                <input type="text" name="jobTitle" placeholder="title" className="w-full rounded-md focus:ring focus:ring-opacity-75 focus:ring-default-600 border-gray-300" defaultValue={jobTitle} />
                            </div>
                            <div className="col-span-full sm:col-span-3">
                                <label className="text-sm">Company name</label>
                                <input type="text" name="CompanyName" placeholder="Company name" defaultValue={companyName} className="w-full rounded-md focus:ring focus:ring-opacity-75 text-gray-900 focus:ring-default-600 border-gray-300" />
                            </div>
                            <div className="col-span-full sm:col-span-3">
                            ...
                            <div className="col-span-full sm:col-span-3">
                                ...
                                <input id="email" type="text" name="location" defaultValue={location} placeholder="City, State" className="w-full rounded-md focus:ring focus:ring-opacity-75 text-gray-900 focus:ring-default-600 border-gray-300" />
                            </div>
                            <div className="col-span-full">
                                <label htmlFor="address" className="text-sm">Company Banner</label>
                                <input id="address" type="text" name="companyBanner" defaultValue={companyBanner} placeholder="Company banner" className="w-full rounded-md focus:ring focus:ring-opacity-75 text-gray-900 focus:ring-default-600 border-gray-300" />
                            </div>
                            <div className="col-span-full sm:col-span-2">
                                <label htmlFor="city" className="text-sm">Salary</label>
                                <input id="city" type="text" placeholder="" defaultValue={salaryRange} name="salaryRange" className="w-full rounded-md focus:ring focus:ring-opacity-75 text-gray-900 focus:ring-default-600 border-gray-300" />
                            </div>
                            <div className="col-span-full sm:col-span-2">
                                <label htmlFor="state" className="text-sm">Employment Type</label>
                                <input id="state" type="text" name="employmentType" defaultValue={employmentType} placeholder="" className="w-full rounded-md focus:ring focus:ring-opacity-75 text-gray-900 focus:ring-default-600 border-gray-300" />
                            </div>
                            <div className="col-span-full sm:col-span-2">
                                <label htmlFor="zip" className="text-sm">Experience Level</label>
                                <input id="zip" type="text" placeholder="" defaultValue={experienceLevel} name="experienceLevel" className="w-full rounded-md focus:ring focus:ring-opacity-75 text-gray-900 focus:ring-default-600 border-gray-300" />
                            </div>
                        </div>
                    </fieldset>
                    <fieldset className=" gap-6 p-6 rounded-md shadow-sm bg-gray-50">
                        ...
                        <div className="grid grid-cols-1 gap-4 col-span-full lg:col-span-3">
                            ...
                            <div className="col-span-full sm:col-span-3">
                                ...
                                <DatePicker selected={postingDate} name="datePosted" d onChange={(date) => setPostingDate(date)} />
                            </div>
                            ...
                            <div className="col-span-full sm:col-span-2">
                                ...
                                <input id="state" type="text" placeholder="" defaultValue={industry} name="industry" className="w-full rounded-md focus:ring focus:ring-opacity-75 text-gray-900 focus:ring-default-600 border-gray-300" />
                            </div>
                            <div className="col-span-full sm:col-span-2">
                                <label htmlFor="zip" className="text-sm">Website</label>
                                <input id="zip" type="text" placeholder="http://" defaultValue={companyWebsite} name="companyWebsite" className="w-full rounded-md focus:ring focus:ring-opacity-75 text-gray-900 focus:ring-default-600 border-gray-300" />
                            </div>
                        </div>
                    </fieldset>
                    <div>
                        <input type="submit" className="btn btn-primary" value="Update Job Post" />
                    </div>
